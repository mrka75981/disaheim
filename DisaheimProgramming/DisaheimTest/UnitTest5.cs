...
namespace DisaheimTest
{
    ...
    public class UnitTest5
    {
        ...
        Amulet a1, a2, a3;
        Course c1, c2, c3;
        IValueableRepository repo;

        [TestInitialize]
        public void Init()
        {
            // Arrange
            repo = new IValueableRepository();

            b1 = new Book("1");
            b2 = new Book("2", "Falling in Love with Yourself");
            b3 = new Book("3", "Spirits in the Night", 123.55);
            repo.AddValueable(b1);
            repo.AddValueable(b2);
            repo.AddValueable(b3);

            a1 = new Amulet("11");
            a2 = new Amulet("12", Level.High);
            a3 = new Amulet("13", Level.Low, "Capricorn");
            repo.AddValueable(a1);
            repo.AddValueable(a2);
            repo.AddValueable(a3);
            ...
            repo.AddValueable(c1);
            repo.AddValueable(c2);
            repo.AddValueable(c3);
        }
